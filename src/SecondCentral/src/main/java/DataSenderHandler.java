...
public class DataSenderHandler implements DataSender.Iface {
    ...
    public DataSenderHandler(ArrayList<String> history,ArrayList<String> CentralHistory , ArrayList<String> ThirdCentralHistory)
    {
...
//        addToHistory();
        ...
        return History + ";" + ArrayToString(CentralHistory) + ";" + ArrayToString(ThirdCentralHistory);
    }
}